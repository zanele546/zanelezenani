    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          address: { "@type": "PostalAddress", addressLocality: "Soweto", addressCountry: "ZA" },
          jobTitle: "Matric graduate seeking internship",
        }),
      },
    ],
  }),
    ...
    <QueryClientProvider client={queryClient}>
      <div className="flex min-h-screen flex-col">
        ...
        <footer className="border-t border-border">
          <div className="mx-auto flex w-full max-w-3xl flex-col gap-1 px-6 py-8 text-sm text-muted-foreground sm:flex-row sm:justify-between">
            <p>
